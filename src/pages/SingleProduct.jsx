    ...
    <div>
      ...
      <div className="mt-6">
        ...
        <div className="form-control w-full max-w-xs">
          <label htmlFor="amount" className="label"><h4 className="text-md font-medium tracking-wider capitalize">amount</h4></label>
          <select name="" id="" className="select select-secondary select-bothered select-md" value={amount} onChange={handleAmount}>
